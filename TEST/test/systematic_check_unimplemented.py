...
각 페이지별로 HTML 파일을 확인하고 테스트 시나리오와 비교
"""
...
def remove_unimplemented_features(content):
    ...
    html_files = {
        ...
        'message-send-election': read_file(os.path.join(base_path, 'message-send-election.html')),
    }
...
def main():
    ...
    backup_path = file_path + '.backup_systematic_check'
    
    print("=" * 80)
    print("HTML 페이지에 구현되지 않은 기능 체계적 제거")
    print("=" * 80)

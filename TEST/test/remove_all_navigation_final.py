...
# -*- coding: utf-8 -*-
"""
단순 메뉴/페이지/탭 이동 확인 시나리오 모두 제거 (최종)
...
def is_simple_navigation_only(line):
    ...
    if (has_simple_nav or has_nav_check) and not has_linked_function:
...
def main():
    ...
    backup_path = file_path + '.backup_navigation_final'
    
    print("=" * 80)
    print("단순 메뉴/페이지/탭 이동 확인 시나리오 모두 제거 (최종)")

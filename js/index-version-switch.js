...
(function () {
    ...
    var isSnapshot = href.indexOf('index.last-commit.html') !== -1;
    ...
    style.textContent = [
        ...
        'border-radius:10px;font-size:13px;font-family:system-ui,-apple-system,sans-serif;',
        'box-shadow:0 4px 24px rgba(0,0,0,.25);',
        '}',
        '#index-version-bar .ivb-label{opacity:.75;margin-right:4px;font-size:12px;}',
        '#index-version-bar a{',
    ...
    if (!isSnapshot) aCurrent.className = 'ivb-active';

    var aPrev = document.createElement('a');
    aPrev.href = 'index.last-commit.html';
    aPrev.textContent = '이전 커밋';
    if (isSnapshot) aPrev.className = 'ivb-active';
